          ...
          Expanded(
            child: StreamBuilder<List<TopicsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<TopicsRecord> listViewTopicsRecordList = snapshot.data;
                ...
                final listViewTopicsRecord = listViewTopicsRecordList.first;
                return ListView(
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          StreamBuilder<List<VersusRecord>>(
                                            stream: queryVersusRecord(
                                              singleRecord: true,
                                            ),
                                            builder: (context, snapshot) {
