  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final wipUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
              ...
              ToggleIcon(
                onPressed: () async {
                  ...
                  final favoritesUpdate =
                      wipUsersRecord.favorites.contains(favoritesElement)
                          ? FieldValue.arrayRemove([favoritesElement])
                          : FieldValue.arrayUnion([favoritesElement]);
                  final usersUpdateData = {
                    'favorites': favoritesUpdate,
                  };
                  await wipUsersRecord.reference.update(usersUpdateData);
                },
                value: wipUsersRecord.favorites
